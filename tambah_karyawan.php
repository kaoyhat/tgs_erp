...
<div class="container-fluid">
    ...
    if (isset($_POST['simpan'])) {
        $koneksi->query("INSERT INTO karyawan (nama,jenis_kelamin,tempat_tgllahir,status,jabatan,no_telp,alamat) VALUES ('$_POST[nama]','$_POST[jenis_kelamin]',
        '$_POST[tempat_tgllahir]','$_POST[status]','$_POST[jabatan]','$_POST[notelp]','$_POST[alamat]')");
        echo "<script>alert('Data Berhasil Disimpan');window.location='data_karyawan.php'</script>";
    }
    ?>