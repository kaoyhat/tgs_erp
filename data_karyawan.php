...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <form action="cari_karyawan.php" method="GET" class="navbar-form navbar-right">
    ...
    <a href="cetak_karyawan.php" class="btn btn-info">Cetak Data </a>
    <br><br>
            ...
            <tbody>
                ...
                <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="hapus_karyawan.php?id=<?php echo $pecah['id_karyawan'] ?>" class="btn-danger btn"><img src="img/delete.png" width="32px"></a>
                            <a href="ubah_karyawan.php?id=<?php echo $pecah['id_karyawan']  ?>" class="btn btn-warning"><img src="img/edit.png" width="32px"></a>
                        </td>
                    </tr>
                    <?php $nomor++ ?>
                <?php } ?>
